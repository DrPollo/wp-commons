							...
							<div class="project-meta-left">
								...
								<?php 
									...
									foreach($g_admins as $admin){
										$a_id = $admin -> user_id; 
										$a_link = bp_core_get_user_domain( $a_id );?>
										<li>
											<a id="user-<?php echo $a_id ?>" href="<?php echo $a_link; ?>">
											<?php 
												echo get_avatar($a_id, 35);
												echo $admin -> user_login;
											?>
											</a>
										</li>
										<?php
									...
									foreach($g_mods as $mod){
										$m_id = $mod -> user_id;
										$m_link = bp_core_get_user_domain( $m_id ); ?>
										<li>
											<a id="user-<?php echo $m_id ?>" href="<?php echo $m_link; ?>">
											<?php 
												echo get_avatar($m_id, 35);
												echo $mod -> user_login;
											?>
											</a>
										</li>
