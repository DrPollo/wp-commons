...
?>
		...
		<article class="post" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post-content">
				<!-- post title -->
				<?php
				infinity_get_template_part( 'templates/parts/idea-meta-top');	
				?>	
				<h2 class="post-title">
				...
				<?php
					infinity_get_template_part( 'templates/parts/idea-meta-bottom');	
				?>
				<?php
