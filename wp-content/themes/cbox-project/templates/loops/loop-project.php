...
?>
			...
			<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
				<div class="post-content">
					...
					echo bp_core_fetch_avatar(array('object' => 'group', 'item_id' => $g_id ) )	;
					?>			
					<h1 class="post-title">
						<?php the_title(); ?>
						<?php edit_post_link(' ✍','',' ');?>
					...
					<div class="entry">
						...
						<h5><?php __('Presentation', 'infinity_text_domain'); ?></h5>
							<ul class="bxslider">
								<li><strong>Impatto sul territorio [TODO]</strong>: <?php echo $p_idea_progetto_group_extension_setting;?></li>
								<li><strong>Sostenibilità economica [TODO]</strong>: <?php echo $p_idea_progetto_group_extension_setting2;?></li>
								<li><strong>Piano marketing [TODO]</strong>: <?php echo $p_impatto_progetto_group_extension_setting;?></li>
							</ul>
					   	</div>
						...
						<div class="project-group-field" id="results">
							<h5><?php _e("Results", "infinity_text_domain"); ?></h5>
							<ul><li>
							<?php
						...
						<div class="project-group-field" id="Timing" >
							<h5><?php _e("Timing", "infinity_text_domain"); ?></h5>
							<ul><li>
							<?php
