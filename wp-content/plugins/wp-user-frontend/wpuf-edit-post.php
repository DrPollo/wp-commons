            ...
            <form name="wpuf_edit_post_form" id="wpuf_edit_post_form" action="" enctype="multipart/form-data" method="POST">
                ...
                <ul class="wpuf-post-form">
					...
					//#riqua
						// mettere if wp geo		
						?>
						<div id="wpgeo_location">
						<div class="inside">
<input type="hidden" name="wpgeo_location_noncename" id="wpgeo_location_noncename" value="4858caa65e"><table cellpadding="3" cellspacing="5" class="form-table">

				<div id="wpgeo_map_admin_post_1" class="wp_geo_map wpgeo_map_admin_post wpgeo_map" style="width: 100%; height: 300px; padding: 0px; margin: 0px; position: relative; background-color: rgb(229, 227, 223); overflow: hidden; -webkit-transform: translateZ(0);">
				</div></div>
				<?php /*<table>
							<tr>
				 <input name="wp_geo_latitude" type="text" size="25" id="wp_geo_latitude" value="" /><br />
				<input name="wp_geo_longitude" type="text" size="25" id="wp_geo_longitude" value="" /><br />
			</tr>
				</table> */ ?>
				</div>						
						<div id="coordinate" style="display:none">
                         <?php //#riqua sposto custom field form e lo metto dentro un div
						 wpuf_build_custom_field_form( 'tag' , true, $curpost->ID ); ?>
						 </div>
						 <?php
//fine #riqua
					 if ( wpuf_get_option( 'allow_tags', 'wpuf_frontend_posting' ) == 'on' ) { ?>
                        <li>
...
<style>
						#autovalutazione li{display:inline-block;width:31%;padding:0 10px;}
						#autovalutazione li label{float:none}
						</style>
						<div id="autovalutazione">
                         <?php //#riqua anche qui lo metto dentro un div
