    ...
    <div class="wrap wpuf-admin custom-fields">
        ...
        if ( isset( $_POST['wpuf_add_custom'] ) ) {
            ...
            if ( !$error ) { //no errors
                ...
                $data = array(
                    'field' => $_POST['field'],
                    //#riqua, sostituisco con quello in alto 'field' => 'cf_' . $_POST['field'],
                    'label' => $_POST['label'],
                    'desc' => $_POST['help'],
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <select name="type" id="type" onchange="wpuf_show(this)">
								...
								<option value="hidden"><?php /* #riqua aggiungo hidden */ _e( 'Hidden', 'wpuf' ); ?></option>
                            </select>
        ...
        <table class="widefat meta" style="margin-bottom: 20px;">
            ...
            if ( $wpdb->num_rows > 0 ):
                ...
                // #riqua aggiungo hidden $type = array('text' => 'Text Box', 'textarea' => 'Text Area', 'select' => 'Dropdown', 'checkbox' => 'Checkbox' );
                $type = array('text' => 'Text Box', 'textarea' => 'Text Area', 'select' => 'Dropdown', 'checkbox' => 'Checkbox', 'hidden' => 'Hidden');
...
function wpuf_custom_fields_edit() {
    ...
    <div class="wrap wpuf-admin">
        ...
        if ( isset( $_POST['wpuf_edit_custom'] ) ) {
            ...
            if ( !$error ) { //no errors
                //whatever, insert the values
                // #riqua if ( !wpuf_starts_with( $_POST['field'], 'cf_' )  ) {
                if ( ( !wpuf_starts_with( $_POST['field'], 'cf_' ) ) || ( !wpuf_starts_with( $_POST['field'], '_wp_geo_l' ) ) ) {
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <select name="type" id="type" onchange="wpuf_show(this)">
                                    ...
                                    <option value="hidden"<?php /* #riqua aggiungo hidden */ selected( $row->type, 'hidden' ); ?>><?php _e( 'Hidden', 'wpuf' ); ?></option>
                                </select>
                                <span class="description"></span>
                            </td>
                        </tr>
